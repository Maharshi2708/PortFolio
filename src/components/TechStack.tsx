...
import tstack from "../assets/Server-amico.svg";
import {
  skillsDataWeb,
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <div className="flex gap-40 justify-end mr-60 max-lg:mr-0 max-lg:flex-col">
          <div className="flex w-2/4 h-3/5 items-center justify-center max-lg:gap-40 max-lg:hidden">
            <img src={tstack} className="h-3/4"></img>
          </div>
